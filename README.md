...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-24 09:07`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c6f50e8c-2cac-4eec-9f6e-04e8bda202b0.git
$ cd c6f50e8c-2cac-4eec-9f6e-04e8bda202b0
```
